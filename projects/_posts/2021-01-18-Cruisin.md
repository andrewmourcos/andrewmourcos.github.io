---
layout: projects
title: Cruisin — Car Tech Upgrade
tag: Robotics
description: Creating my own ADAS 
tools: CAN, C++, OpenCV, TF
img: Media/cruisin/flow.gif
---
Cruisin is my attempt at creating a custom Advanced Driver Assistance System (ADAS). I was too excited to see the recent advances in autonomous driving and couldn't help but trying to learn a thing or two with a hands-on project.
